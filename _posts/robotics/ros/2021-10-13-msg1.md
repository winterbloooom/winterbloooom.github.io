...
본격적인 커스텀 메시지 만들기에 앞서, 이 기능을 수행할 패키지를 만들자. 패키지 제작의 상세한 내용은 이전 포스팅 [[ROS] 패키지 빌드와 노드 작성](https://winterbloooom.github.io/robotics/ros/2021/10/07/package_node.html)에 있으므로 참고하고, 이번에는 절차만 소개하겠다.
